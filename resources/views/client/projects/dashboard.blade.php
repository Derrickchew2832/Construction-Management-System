    ...
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-end align-items-center mb-3">
            ...
            <div class="d-flex align-items-center">
                ...
                <input type="text" class="form-control w-auto search-bar" placeholder="Search projects" id="searchInput"
                            ...
                            @php
                                ...
                                switch ($projectStatus) {
                                    case 'completed':
                                        ...
                                        $ribbonClass = 'bg-success';
                                        break;
                                    case 'started':
                                        $ribbonText = 'In Progress';
                                        $ribbonClass = 'bg-warning';
                                        break;
                                    default:
                                        $ribbonText = 'Project Created';
                                        $ribbonClass = 'bg-secondary';
                                        break;
                                }
                            @endphp
